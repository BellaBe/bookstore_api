...
module.exports = function(lib){
    ...
    controller.addAction({
        'path': '/stores/{id}',
        'method': 'GET',
        'params': [swagger.pathParam('id', 'The id of the sotre', 'string')],
    ...
    controller.addAction({
        ...
        'summary': 'Retruns the list of books of the store',
        'responseClass': 'Book',
    ...
    controller.addAction({
        ...
        'method': 'GET',
        'params': [swagger.pathParam('id', 'The id of the store', 'string')],
        'summary': 'Returns the list of the sales done on a store',
    ...
    controller.addAction({
        ...
        if(data) {
            ...
            net(controller.RESTError('InvalidArgumentError', 'No data received'))
        }
    })
    controller.addAction({
        'path': '/stores/{id}',
